...
import { Tag, Star, Package, Calendar, Globe, ShieldCheck, Trophy, ArrowRight } from 'lucide-react';
...
const TRUST_ITEMS = [
  { icon: ShieldCheck, title: "Certified Quality",  desc: "All brands meet international quality standards", iconBg: "rgba(16,185,129,0.1)",  iconColor: "#059669" },
  { icon: Trophy,      title: "Award Winning",      desc: "Recognized globally for innovation",             iconBg: "rgba(26,135,225,0.1)",  iconColor: "#1a87e1" },
  { icon: Globe,       title: "Global Reach",       desc: "Trusted in over 100 countries worldwide",        iconBg: "rgba(245,158,11,0.1)",  iconColor: "#d97706" },
  { icon: Star,        title: "Top Rated",          desc: "Highly rated by healthcare professionals",       iconBg: "rgba(239,68,68,0.1)",   iconColor: "#dc2626" },
];
  ...
  return (
    <div className="min-h-screen" style={{ background: C.bg, fontFamily: FONT.body }}>
      ...
      >
        ...
        <p className="text-base max-w-[600px] mx-auto" style={{ color: "rgba(255,255,255,0.75)" }}>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  boxShadow:  active ? "0 4px 12px rgba(26,135,225,0.25)" : "none",
                }}
              >
                {cat}
              </button>
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-10">
        {filteredBrands.length === 0 ? (
          ...
          >
            ...
            <p className="text-[15px] font-semibold" style={{ color: C.textSoft }}>
          ...
          <div className="grid grid-cols-2 gap-5">
            {filteredBrands.map((brand) => (
              ...
              >
                ...
                >
                  <div>
                    <p className="text-[18px] font-bold" style={{ color: C.textPrimary }}>
                      {brand.name}
                    </p>
                    <p className="text-[12px] font-medium mt-[3px]" style={{ color: C.accent }}>
                      {brand.tagline}
                    </p>
                  </div>
                  <span
                ...
                <div className="px-5 py-[18px]">
                  ...
                  >
                    {[
                      ...
                      { icon: Package,  value: brand.products,    label: "Products" },
                      { icon: Calendar, value: brand.established, label: "Est."     },
                      { icon: Globe,    value: brand.country,     label: "Country"  },
                    ].map(({ icon: Icon, value, label }) => (
                      <div key={label} className="text-center">
                        <div className="flex items-center justify-center gap-1">
                          <Icon size={12} color={C.textMuted} />
                          <span className="text-[14px] font-bold" style={{ color: C.textPrimary }}>
                            {value}
                          </span>
                        </div>
                        <p className="text-[10px] mt-[2px]" style={{ color: C.textMuted }}>
                          {label}
                        </p>
                      </div>
                    ))}
                  ...
                  <div className="grid grid-cols-3 gap-[10px] mb-4">
                    {[
                      { icon: ShieldCheck, label: "Certified",    bg: "rgba(16,185,129,0.08)",  color: "#059669" },
                      { icon: Trophy,      label: "Award Winner", bg: "rgba(26,135,225,0.08)",  color: "#1a87e1" },
                      { icon: Star,        label: "Top Rated",    bg: "rgba(245,158,11,0.08)",  color: "#d97706" },
                      ...
                      >
                        <Icon size={18} color={color} className="mx-auto mb-[5px]" />
