...
const OrderSummary = ({ formData, handleInputChange, handlePlaceOrder, isLoading }) => {
    const formattedSubtotal = `${ORDER_FINANCIALS.CURRENCY} ${ORDER_FINANCIALS.SUBTOTAL.toLocaleString('en-US', { minimumFractionDigits: 2 })}`;
    const formattedTotal = `${ORDER_FINANCIALS.CURRENCY} ${ORDER_FINANCIALS.TOTAL.toLocaleString('en-US', { minimumFractionDigits: 2 })}`;
