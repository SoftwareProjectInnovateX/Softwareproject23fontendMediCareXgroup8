...
const Checkout = () => {
    ...
    const processOnlinePayment = async (orderId) => {
        ...
        try {
            ...
            const hashRes = await fetch(`${API_BASE_URL}/customer-orders/generate-hash?orderId=${orderId}&amount=${PAYMENT_GATEWAY_CONFIG.TOTAL_AMOUNT}&currency=${PAYMENT_GATEWAY_CONFIG.CURRENCY}`);
