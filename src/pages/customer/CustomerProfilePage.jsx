...
// ── InfoRow ──────────────────────────────────────────────────────────────────
function InfoRow({ icon: Icon, label, value, accent, isDark = false }) {
  return (
    <div
      className="flex items-center gap-3 px-4 py-3 rounded-[10px]"
      style={{
        background: isDark ? "rgba(255,255,255,0.04)" : "rgba(26,135,225,0.03)",
        border: `1px solid ${C.border}`,
      }}
    >
      <div
        ...
        style={{
          background: isDark ? "rgba(255,255,255,0.1)" : "rgba(26,135,225,0.1)",
        }}
      >
...
function QuickLinkCard({
  ...
  return (
    <div
      ...
      onMouseEnter={(e) =>
        (e.currentTarget.style.boxShadow = "0 4px 16px rgba(26,135,225,0.14)")
      }
      onMouseLeave={(e) =>
            ...
            {!editing ? (
              ...
              <div className="flex gap-2">
                <button
                  ...
                  style={{
                    color: C.textMuted,
                    background: isDark ? DARK.surfaceDeep : "#f1f5f9",
                    border: `1px solid ${C.border}`,
                    fontFamily: FONT.body,
                  }}
                >
              ...
              <>
                ...
                <Field label="Email" icon={Mail}>
                  <input
                    style={{
                      ...inputStyle(isDark),
                      background: isDark ? DARK.surfaceDeep : "#f8fafc",
                      color: C.textMuted,
                      cursor: "not-allowed",
                    }}
                    value={user.email}
