...
import {
  ...
  Pill, Heart, Baby, Eye, Ear, Bone, Brain, Stethoscope,
  Thermometer, Syringe, FlaskConical, Leaf, Sun, Droplets,
  Shield, Smile, Dumbbell, Apple, Wind, Bandage, Microscope,
                ...
                {categories.map((cat) => {
                  ...
                  return (
                    <button
                      ...
                      onMouseLeave={e => { if (!active) e.currentTarget.style.background = active ? "rgba(26,135,225,0.07)" : "transparent"; }}
                    >
