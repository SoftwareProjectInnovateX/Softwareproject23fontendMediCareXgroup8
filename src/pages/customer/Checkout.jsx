...
const Checkout = () => {
    ...
    const PAYMENT_GATEWAY_CONFIG = {
        ...
        NOTIFY_URL: `${(import.meta.env.VITE_API_URL_RAILWAY && import.meta.env.VITE_API_URL_RAILWAY !== 'undefined' ? import.meta.env.VITE_API_URL_RAILWAY : 'http://localhost:5000')}/api/customer-orders/notify`,
    ...
    const handlePlaceOrder = async () => {
        ...
        if (orderData.paymentMethod === 'ONLINE') {
            ...
            try {
                ...
                const response = await fetch(`${(import.meta.env.VITE_API_URL_RAILWAY && import.meta.env.VITE_API_URL_RAILWAY !== 'undefined' ? import.meta.env.VITE_API_URL_RAILWAY : 'http://localhost:5000')}/api/customer-orders`, {
                    method: 'POST',
    ...
    const processOnlinePayment = async (orderId) => {
        ...
        try {
            ...
            const hashRes = await fetch(`${(import.meta.env.VITE_API_URL_RAILWAY && import.meta.env.VITE_API_URL_RAILWAY !== 'undefined' ? import.meta.env.VITE_API_URL_RAILWAY : 'http://localhost:5000')}/api/customer-orders/generate-hash?orderId=${orderId}&amount=${PAYMENT_GATEWAY_CONFIG.TOTAL_AMOUNT}&currency=${PAYMENT_GATEWAY_CONFIG.CURRENCY}`);
